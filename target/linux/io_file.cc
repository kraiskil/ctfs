...
void listen_for_croaks(int16_t *buffer)
{
	...
	switch(option)
	{
		case 1: rdptr = snd_pure_1kHz;        break;
		case 2: rdptr = snd_pure_1kHz_fadein; break;
		case 3: rdptr = snd_noise;            break;
		case 4: rdptr = snd_noise_loud;       break;
		default:
			std::cout << "didn't understand, hearing zeros" << std::endl;
			// fall-through
		case 5: rdptr = snd_zero;             break;
	}
